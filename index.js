...
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .status { font-size: 0.95em; color: #666666; font-weight: 600; margin-bottom: 25px; }
            ...
            .input-title { text-align: left; font-size: 0.9em; font-weight: bold; margin-bottom: 8px; color: #333; text-align: center; }
